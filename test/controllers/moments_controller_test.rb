...
class MomentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create moment" do
    assert_difference('Moment.count') do
      post moments_url, params: { moment: { bad: @moment.bad, good: @moment.good, okay: @moment.okay } }
    end
  ...
  test "should update moment" do
    patch moment_url(@moment), params: { moment: { bad: @moment.bad, good: @moment.good, okay: @moment.okay } }
